...
enum State {
  comeOut, point, win, loss
}

class Roll {
  final int _die1; // in Dart ints and other numbers are objects, but they
  // still have lower-case names
  final int _die2;
...
class Round {
  ...
  //creates an unmodifiable list of the elements from the original list
...
class Snapshot {
  ...
  //the params that get passed in will be assigned to these fields in this class
